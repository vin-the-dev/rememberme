...
class OnBoardingViewController: UIViewController, PaperOnboardingDataSource {
    ...
    func onboardingItemAtIndex(_ index: Int) -> OnboardingItemInfo {
        ...
        return [
            ("theme", "Re-Connect!", "We have more than on an average of more than 500 contacts. Most of them from facebook, outlook etc. But how many of them we contact on a weekly basis. Not more have 10-20. Rest is just there in the contact list and we never know most of them. Re-Connect will select randomly set of three contacts", "", UIColor(red:0.40, green:0.63, blue:0.49, alpha:1.00), UIColor.white, UIColor.white, titleFont,descriptionFont),
            ("Contact Card", "Contacts", "Swipe Left/Right/Shake to refresh the list, You may find your old friend or an old colleague. Tap the contact and see more details. You can directly call, sms or e-mail them for here. I bet you will find a person you long forgot if the first few swipes. Hope this will help you to get aqquiented with some one you forgot.", "", UIColor(red:0.40, green:0.69, blue:0.71, alpha:1.00), UIColor.white, UIColor.white, titleFont,descriptionFont),
