...
class OnBoardingViewController: UIViewController, PaperOnboardingDataSource {
    ...
    func onboardingItemAtIndex(_ index: Int) -> OnboardingItemInfo {
        ...
        return [
            ("theme", "Re-Connect!", "We have on an average more than 500 contacts. Most of them from facebook, outlook etc. But how many of them we contact on a weekly basis?. Not more have 10-20. Rest is just there in the contact list and we never know most of them. Re-Connect will select randomly set of three contacts", "", UIColor(red:0.40, green:0.63, blue:0.49, alpha:1.00), UIColor.white, UIColor.white, titleFont,descriptionFont),
